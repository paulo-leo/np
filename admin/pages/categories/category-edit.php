...
if(isset($_GET['page']) and $_GET['page'] == "edit-category"){
	$id = intval($_GET['id']);	
    $sql1 = "SELECT * FROM ".NP."categories WHERE ID = {$id}";
    $cat = np_obj($sql1); 
}
?>
<style>
...
<?php np_action("editCategory"); ?>
<input type="hidden" name="category_id" value="<?php echo $cat->ID; ?>"/>
<div class="col m8">
<h4><i class='material-icons'>view_list</i> Editar categoria</h4><p>
<input type="text" name="name" value="<?php echo $cat->category_name; ?>" placeholder="Digite o nome aqui" class="input border card" style="border-radius:2px"/>
</p><br>
<textarea name="description"  placeholder="Digite a descrição da categoria aqui." style="min-height:200px !important;" class="input border card"><?php echo $cat->category_description; ?></textarea><p class="small">
...
<input type="submit" class="np-btn round small padding margin left blue np-animate-submit" value="Atualizar categoria"/>
<br><br><br>
...
$("#form-post-update").submit(function(){
	$.ajax({
		   ...
		   type:"post",
		   beforeSend: function(){
				msgPost.html("<p class='animate-fading panel padding pale-blue'>Por favor, aguarde! Atualizando categoria...</p>");
